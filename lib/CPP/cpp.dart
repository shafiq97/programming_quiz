...
class CppQuiz extends StatefulWidget {
  const CppQuiz({super.key});

  @override
  _CppQuizState createState() => _CppQuizState();
}

class _CppQuizState extends State<CppQuiz> {
  List<dynamic> _questions = [];
  List<String> _selectedValues = [];

  Future<void> _fetchQuestions() async {
    final response =
        await http.get(Uri.parse('http://192.168.68.105:3001/api/data/cpp'));
